      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#5FA8D3] to-[#4A95C0] p-12 flex-col justify-between">
        <div>
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-2xl font-bold text-white">RI'SERVE</span>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            <img src={theme === 'dark' ? '/logo-dark.png' : '/logo-light.png'} alt="Logo" className="w-10 h-10" />
            <span className={`text-xl font-bold ${theme === 'dark' ? 'text-[#E6E8EB]' : 'text-[#0E1116]'}`}>RI'SERVE</span>
          </div>
