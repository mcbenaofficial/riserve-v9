...
# ── Menu data: (category, name, desc, price_usd, is_veg, nutritional_value, image, tags) ──
MENU_JP = [
    # Starters
    ("Starters", "Edamame",
...
MENU_FR = [
    ...
    # Drinks
    ("Drinks", "Kir Royal",
     "Crème de cassis with Billecart-Salmon Brut Réserve Champagne.",
     22, True,
...
async def seed():
    async with AsyncSessionLocal() as db:
        ...
        company = models_pg.Company(
            ...
            address="One Hospitality Plaza, New York, NY 10013",
            plan="pro",
            plan_limits={"outlets": -1, "bookings_per_month": -1},
            status="active",
            enabled_features=["inventory", "restaurant_orders", "crm",
                               "staff_management", "finance", "smart_analytics"],
            licensed_modules=["booking", "inventory", "restaurant_orders",
                               "customer_360", "finance", "smart_analytics"],
        ...
        outlets_data = [
            (OUTLET_JP_ID, "Azabu Kadowaki", "Japanese",
             "148 W Broadway, Tribeca, New York, NY 10013",
             "kadowaki@riserve.ai", "+1-212-555-0201",
             60, 40.7195, -74.0089),
            (OUTLET_IT_ID, "La Palanca", "Italian",
             "317 Bleecker St, West Village, New York, NY 10014",
             "lapalanca@riserve.ai", "+1-212-555-0202",
             70, 40.7329, -74.0025),
            (OUTLET_FR_ID, "Benoit Paris", "French",
             "60 W 55th St, Midtown, New York, NY 10019",
             "benoit@riserve.ai", "+1-212-555-0203",
             80, 40.7630, -73.9773),
        ]
        outlet_objects = {}
        ...
        db.add(models_pg.InvoiceSettings(
            ...
            tax_name="Sales Tax",
            default_tax_rate=Decimal("8.875"),
            currency="USD",
            currency_symbol="$",
            invoice_company_name="Ri'Serve Hospitality LLC",
            invoice_company_address="One Hospitality Plaza, New York, NY 10013",
        ...
        for outlet_id in [OUTLET_JP_ID, OUTLET_IT_ID, OUTLET_FR_ID]:
            ...
            for cust_id, lines in invoice_acc.items():
                ...
                tax_amt  = (subtotal * Decimal("0.08875")).quantize(Decimal("0.01"))
